...
export function ThemeSelector({ onThemeChange }: ThemeSelectorProps) {
  ...
  return (
    <div className="fixed top-4 right-4 z-50">
      ...
      {isOpen && (
        <Card className="absolute top-14 right-0 w-80 shadow-2xl border-0 bg-white/95 backdrop-blur-xl">
            ...
            <div className="grid grid-cols-2 gap-3">
              {themes.map((theme) => (
                ...
                >
                  ...
                  <div className={`w-full h-4 bg-gradient-to-r ${theme.secondary} rounded mb-2`}></div>
